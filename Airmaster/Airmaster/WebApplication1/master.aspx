<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="master.aspx.cs" Inherits="WebApplication1.pure" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>MASTER系列 | AIR MASTER</title>
...
<body>
    ...
    <div class="page-content">
        ...
        <ul style="list-style:none;padding:0;margin:0">
            <li><img src="images/master_1.jpg" alt="1"/></li>
            <li style="display:none"><img src="images/master_2.jpg" alt="2"/></li>
