<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="smell-buy.aspx.cs" Inherits="WebApplication1.smell_buy" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="buy-pure-title">购买香氛精油</div>

        <asp:Panel runat="server" ID="step1" >
        <div class="buy-stepbox">
            <div><span style="font-size:24px;">1</span> 选择具体类型</div>
            <div style="margin-top:30px;overflow:hidden">
                <div class="buy-category-box"> 浓郁花香型 </div>
                <div  class="buy-category-box"> 水果香味型 </div>
                <div  class="buy-category-box"> 食物香味型 </div>
            </div>
        ...
        <div class="buy-stepbox">
            ...
            <div style="margin-top:30px">
            <asp:Button runat="server" Text="下一步" ID="step2ButtonNext" style="float:right" 
        ...
        <div class="buy-stepbox">
            ...
            <div style="margin-top:30px">
            <asp:Button runat="server" Text="下一步" ID="step3ButtonNext" style="float:right" 
                    class="smell-buy-button" onclick="step3ButtonNext_Click"/>
            <asp:Button runat="server" Text="上一步" ID="step3ButtonPrev" style="float:right" 
        ...
        <div class="buy-stepbox">
            ...
            <div style="margin-top:30px">
            <asp:Button runat="server" Text="创建订单" ID="step4ButtonNext" style="float:right" 
                    class="smell-buy-button" onclick="step4ButtonNext_Click"/>
             <asp:Button runat="server" Text="上一步" ID="step4ButtonPrev" style="float:right" 
